...
int main() {
  ...
  //                DocumentStatus::ACTUAL, {1, 2});
  //
  //    // множество слов такое же, как в id 6, несмотря на другой порядок,
  ////    считаем
  //    // дубликатом
  ...
  //    }
  {
    LOG_DURATION("ADD");
    for (int i = 1; i < 10; ++i) {
      AddDocument(search_server, i, "nasty rat with curly hair"s,
                  DocumentStatus::ACTUAL, {1, 2});
    }
  }
